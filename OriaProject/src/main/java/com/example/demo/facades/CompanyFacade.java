...
public class CompanyFacade implements CouponClientFacade {
	 ...
	 */
	public void createCoupon(Coupon coupon) throws CouponExistException, CompanyNotFoundException {
		// Checking Company
	 ...
	 * @throws CouponNotFoundException
	 */
	public Coupon getCoupon(int couponId) throws CompanyNotFoundException, CouponNotFoundException {
	 ...
	 */
	public ArrayList<Coupon> getAllCoupons() throws CompanyNotFoundException, CouponsNotFoundException {
		// Checking Company
		if (loginCompany == null) {
			throw new CompanyNotFoundException("Company not logged in.");
		}
	...
	public ArrayList<Coupon> getCompanyCouponsByType(CouponType type)
			throws CompanyNotFoundException, CouponsNotFoundException {
		// Checking Company
		if (loginCompany == null) {
			throw new CompanyNotFoundException("Company not logged in.");
		}
