...
public class CustomerFacade implements CouponClientFacade {
	...
	public void purchaseCoupon(int couponId) throws CustomerNotFoundException, CouponExistException,
			IllegalAmountException, ExpiredCouponException, CouponNotFoundException {
		// Checking Customer
	 ...
	 */
	public ArrayList<Coupon> getAllCoupons() throws CustomerNotFoundException, CouponsNotFoundException {
		// Checking Customer
		if (loginCustomer == null) {
			throw new CustomerNotFoundException("Customer is not logged in");
		}
	 ...
	 * @throws CouponsNotFoundException
	 */
	public ArrayList<Coupon> getCouponsByPrice(double price) throws CustomerNotFoundException, CouponsNotFoundException {
		// Checking Customer
		if (loginCustomer == null) {
			throw new CustomerNotFoundException("Customer is not logged in");
		}
